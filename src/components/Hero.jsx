    ...
    <div>
      <div className="dark:bg-white">
        <div className="max-w-[800px] mt-[-96px] w-full h-screen text-center mx-auto flex flex-col justify-center">
          ...
          <h1 className="md:text-7xl sm:text-6xl dark:text-black text-white text-4xl font-bold md:py-6">
            Grow with data.
          </h1>
          <div className="flex justify-center items-center">
            <p className="md:text-5xl sm:text-4xl text-xl dark:text-black text-white font-bold">
